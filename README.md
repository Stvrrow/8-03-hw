# Домашнее задание к занятию "`Домашнее задание к занятию «GitLab»`" - `Стрельников Александр`
...
1. Репозиторий запушен в соответсвии с заданием. (Ранее было указано другое имя проекта. Пересоздал, так как возникли проблемы с первым)
